...
const App: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { key: 'taxsettings', label: 'Tax Settings', section: 'SETUP', configured: inputs.includeIRMAA || inputs.includeStateTax || inputs.includeMedicarePremiums || inputs.includeAcaPremiumCredits },
